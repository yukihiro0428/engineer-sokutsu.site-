			  ...
			  <tr class="tr-third">
				<td class="tr-third__left">
				  <ul>
					...
					if ( get_field( 'capacity' ) ) :
						?>
						<li><span class="span">定</span>員：</li><?php endif; ?>
					<?php
				...
				<td class="tr-third__right">
				  <ul>
					...
					if ( get_field( 'capacity' ) ) :
						?>
						<li><?php the_field( 'capacity' ); ?>名</li><?php endif; ?>
					<?php
					if ( get_field( 'speakers' ) ) :
						?>
						<li><?php the_field( 'speakers' ); ?></li><?php endif; ?>
					<?php
					if ( get_field( 'target_person' ) ) :
						?>
						<li class="text"><?php the_field( 'target_person' ); ?></li><?php endif; ?>
				  </ul>
				</td>
			  </tr>
...
日
			  ...
			  <table>
					...
					if ( get_field( 'place' ) ) :
						?>
						<tr><td class="td__left--app"><span>場</span>所：</td><td><?php the_field( 'place' ); ?></td></tr><?php endif; ?>
					<?php
					if ( get_field( 'speakers' ) ) :
						?>
						<tr><td class="td__left--app">登壇者：</td><td><?php the_field( 'speakers' ); ?></td></tr><?php endif; ?>
					<?php
					if ( get_field( 'target_person' ) ) :
						?>
						<tr><td class="td__left--app">対象者：</td><td class="td__right"><?php the_field( 'target_person' ); ?></td></tr><?php endif; ?>
			  </table>
			</div>
		  </li>
		  <?php endwhile; ?>
